...
<div class="panel panel-default panel-tour" id="Certified Panel">
    ...
    <div class="panel-body">
        <p>
            <?php echo Yii::t('CertifiedModule.widgets_views_certifiedPanel', 'You need to get certified as a real person in order to unlock some great features like email and picture gallery.
